...
public class ReceiptItemPlacementDto
{
    ...
    /// <summary>Quantity placed. Positive for Standard items; zero for Unit/AssembledBundle placements.</summary>
    ...
    /// <summary>Set for AssembledBundle item placements.</summary>
