...
import type {
  ...
  RolesUpdateError,
  RolesUpdateResponse,
  UsersAddPermissionData,
  UsersAddPermissionError,
  UsersAddPermissionResponse,
  UsersAddRoleData,
  UsersAddRoleError,
  UsersAddRoleResponse,
  UsersCreateData,
  UsersCreateError,
  UsersCreateResponse,
  UsersDeleteData,
  ...
  UsersGetPermissionsData,
  UsersGetPermissionsError,
  UsersGetPermissionsResponse,
  UsersGetRolesData,
  UsersGetRolesError,
  UsersGetRolesResponse,
  UsersRemovePermissionData,
  UsersRemovePermissionError,
  UsersRemovePermissionResponse,
  UsersRemoveRoleData,
  UsersRemoveRoleError,
...
export const usersGetPermissionsQueryKey = (options: Options<UsersGetPermissionsData>) =>
  createQueryKey("usersGetPermissions", options);

/**
 * Get a user's effective permissions (role + direct).
 */
export const usersGetPermissionsOptions = (options: Options<UsersGetPermissionsData>) =>
  queryOptions<
    UsersGetPermissionsResponse,
    UsersGetPermissionsError,
    UsersGetPermissionsResponse,
    ReturnType<typeof usersGetPermissionsQueryKey>
  >({
    queryFn: async ({queryKey, signal}) => {
 ...
 */
export const usersAddPermissionMutation = (
  options?: Partial<Options<UsersAddPermissionData>>,
): UseMutationOptions<
  UsersAddPermissionResponse,
  UsersAddPermissionError,
  Options<UsersAddPermissionData>
> => {
  const mutationOptions: UseMutationOptions<
    UsersAddPermissionResponse,
    UsersAddPermissionError,
 ...
 */
export const usersRemovePermissionMutation = (
  options?: Partial<Options<UsersRemovePermissionData>>,
): UseMutationOptions<
  UsersRemovePermissionResponse,
  UsersRemovePermissionError,
  Options<UsersRemovePermissionData>
> => {
  const mutationOptions: UseMutationOptions<
    UsersRemovePermissionResponse,
    UsersRemovePermissionError,
...
export const usersGetRolesQueryKey = (options: Options<UsersGetRolesData>) =>
  createQueryKey("usersGetRoles", options);

/**
 * Get the roles assigned to a user.
 */
export const usersGetRolesOptions = (options: Options<UsersGetRolesData>) =>
  queryOptions<
    UsersGetRolesResponse,
    UsersGetRolesError,
    UsersGetRolesResponse,
    ReturnType<typeof usersGetRolesQueryKey>
  >({
    queryFn: async ({queryKey, signal}) => {
 ...
 */
export const usersAddRoleMutation = (
  options?: Partial<Options<UsersAddRoleData>>,
): UseMutationOptions<UsersAddRoleResponse, UsersAddRoleError, Options<UsersAddRoleData>> => {
  const mutationOptions: UseMutationOptions<
    UsersAddRoleResponse,
    UsersAddRoleError,
    Options<UsersAddRoleData>
  > = {
    mutationFn: async (fnOptions) => {
 ...
 */
export const usersRemoveRoleMutation = (
  options?: Partial<Options<UsersRemoveRoleData>>,
): UseMutationOptions<
  UsersRemoveRoleResponse,
  UsersRemoveRoleError,
  Options<UsersRemoveRoleData>
> => {
  const mutationOptions: UseMutationOptions<
    UsersRemoveRoleResponse,
    UsersRemoveRoleError,
