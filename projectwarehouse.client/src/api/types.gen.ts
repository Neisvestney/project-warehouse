...
export type ErrorCode = 'invalidCredentials' | 'tokenOutdated' | 'tokenInvalid' | 'refreshTokenInvalid' | 'refreshTokenExpired' | 'refreshTokenRevoked' | 'permissionDenied' | 'roleProtected' | 'userNotFound' | 'roleNotFound' | 'permissionNotFound' | 'userAlreadyExists' | 'roleAlreadyExists' | 'permissionAlreadyAssigned' | 'required' | 'tooShort' | 'tooLong' | 'invalidFormat' | 'outOfRange' | 'invalidJson' | 'validationError';
...
export type PermissionName = 'users.view' | 'users.create' | 'users.edit' | 'users.delete' | 'users.manage_roles' | 'users.manage_permissions' | 'roles.view' | 'roles.create' | 'roles.edit' | 'roles.delete' | 'roles.manage_permissions';
...
export type PermissionsGetAllResponse = PermissionsGetAllResponses[keyof PermissionsGetAllResponses];
...
export type RolesGetPermissionsResponse = RolesGetPermissionsResponses[keyof RolesGetPermissionsResponses];
...
export type RolesAddPermissionResponse = RolesAddPermissionResponses[keyof RolesAddPermissionResponses];
...
export type RolesRemovePermissionError = RolesRemovePermissionErrors[keyof RolesRemovePermissionErrors];
...
export type RolesRemovePermissionResponse = RolesRemovePermissionResponses[keyof RolesRemovePermissionResponses];
...
export type UsersGetPermissionsResponse = UsersGetPermissionsResponses[keyof UsersGetPermissionsResponses];
...
export type UsersAddPermissionResponse = UsersAddPermissionResponses[keyof UsersAddPermissionResponses];
...
export type UsersRemovePermissionError = UsersRemovePermissionErrors[keyof UsersRemovePermissionErrors];
...
export type UsersRemovePermissionResponse = UsersRemovePermissionResponses[keyof UsersRemovePermissionResponses];
...
export type WeatherForecastGetResponse = WeatherForecastGetResponses[keyof WeatherForecastGetResponses];
