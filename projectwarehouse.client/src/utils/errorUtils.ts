...
export const errorCodeMessages: Record<ErrorCode, string> = {
  ...
  inboundOrderNotFound: "Ордер не найден",
  inboundOrderDraftItemsGroupNotFound: "Позиция ордера не найдена",
  inboundOrderInvalidStatus: "Недопустимый статус ордера для этой операции",
  inboundOrderDraftItemsMissingCatalogLink: "Не все позиции привязаны к товарам из каталога",
  inboundOrderDraftItemsValidationFailed: "Ошибка валидации позиций черновика",
  inboundOrderNotAssigned: "Вы не назначены на этот ордер",
  inboundOrderNodeAlreadyHasItems: "В этом узле уже размещены товары",
  inboundOrderInsufficientProcessedItems: "Недостаточно обработанных товаров для удаления",
